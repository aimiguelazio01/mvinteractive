---
name: send-appleharmonics-email
description: Send the MVs Apple Harmonics Portuguese or English marketing email (email_pt.html or email_en.html) to a specified recipient email address via Resend API. Use when the user asks to send the apple harmonics email or fruit symphony email.
---

# Send Apple Harmonics Email

Sends the MVs Apple Harmonics HTML email template to a recipient using the Resend API.

## When to Use

Use this skill when the user asks to:
- Send the apple harmonics email / fruit symphony email / organic symphony email to an email address
- Send `email_pt.html` or `email_en.html` from `appleharmonics_email` directory to someone
...
2. Run the `send_to.js` script from the `appleharmonics_email` directory.
...
**Working directory:** `c:\Users\corsair\Desktop\_web_page\public\appleharmonics_email`
...
- Sends via Resend API from `MVs Apple Harmonics <hello@mvirgilstudio.com>` using the selected API key
...
| Setting    | Value                                                                              |
|------------|------------------------------------------------------------------------------------|
| From       | MVs Apple Harmonics \<hello@mvirgilstudio.com\>                                    |
| Reply-To   | mvirgilstudio@gmail.com                                                            |
| Subject PT | Instalação Interativa com Maçã de Alcobaça para Feiras e Eventos   |
| Subject EN | Apple Harmonics: Interactive Audio-Tactile Installation                            |
