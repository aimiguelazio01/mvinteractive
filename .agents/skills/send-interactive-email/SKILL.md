...
2. Run the `send_to.js` script from the `interactive_email` directory.
...
- Sends via Resend API from `MVs Interactive <hello@mvirgilstudio.com>` using the selected API key
